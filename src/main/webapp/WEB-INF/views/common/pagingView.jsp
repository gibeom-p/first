...
value="action=${ requestScope.action }&keyword=${ requestScope.keyword }&begin=${ requestScope.begin }&end=${ requestScope.end }" />
...
<div style="text-align: center;">
	...
	<c:if test="${ paging.currentPage gt 1}"> <%-- gt : greater than, > 연산자를 의미 --%>
	...
	<%-- 마지막 페이지로 이동 --%>
	<c:if test="${ paging.currentPage ge paging.maxPage}"> <%-- ge : greater equal, >= 연산자를 의미 --%> 
		[맨끝] &nbsp;
	</c:if>
