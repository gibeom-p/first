...
반복 확인<br>
 ...
 <h4>c:url 태그 : 다른 jsp 페이지나 컨트롤러로 연결 요청 처리할 때 사용하는 태그 (url 재작성을 위한 태그)</h4>
 ...
 <h4>c:import 태그 : jsp 지시자(directive) 태그의 include 지시자 또는 jsp:include 표준 액션태그와 같은 기능 수행</h4>
 별도로 작성된 jsp 또는 html 파일을 원하는 위치에 가져다 표시할 수 있음 (포함시키다.) <br>
 전체 뷰 페이지에서 반복되는 영역 또는 메뉴바, 햄버거 메뉴 등을 표시할 때 주로 사용됨 <br>
 <hr>
 ...
 <h4>c:redirect 태그 : reponse.sendRedirect() 메소드와 같은 태그 </h4>
